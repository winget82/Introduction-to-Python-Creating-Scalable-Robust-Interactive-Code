...
# THIS WILL NEED TO BE SET UP FOR JUPYTER NOTEBOOKS TO PASS
% % writefile
cipher.py
...
def parse_command_line():
    ...
    parser.add_argument('-o outfile_path', '--outfile', metavar='', type=str, help='outfile_path output file')
...
def read_file(file_path):
    ...
    # TODO: Your code goes here
    try:
        with open(file_path, 'r') as message_in:
            message = str(message_in.read())
            return message
...
def write_file(message, file_path):
    ...
    # TODO: Your code goes here
    try:
        with open(file_path, 'w+') as message_out:
            message_out.write(str(message))
    except Exception as exception_object:
        print("unexpected error: {0:}".format(exception_object))
    pass
    ...
    if decrypt == True:
        ...
        for char in str(message):
            if char.isalpha() == True:
                shifted_char = shift(char, key)
                transformed_message += str(shifted_char)
            else:
